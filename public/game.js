...
const ROLES_DATA = [
  {
    ...
    camp: "Loups-Garous",
    color: "#c0392b",
    desc: "Chaque nuit, se réveille avec les autres loups pour dévorer un villageois.",
  ...
  },
  {
    ...
    camp: "Solitaires",
    color: "#bdc3c7",
    desc: "Gagne seul. Une nuit sur deux peut éliminer un loup.",
    tags: ["Solitaire"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Loups-Garous",
    color: "#e74c3c",
    desc: "Voit le camp d'un joueur chaque nuit, en plus de chasser avec les loups.",
    tags: ["Voyance", "Nuit"],
    min: 0,
    max: 2,
    base: false,
  ...
  },
  {
    ...
    camp: "Loups-Garous",
    color: "#922b21",
    desc: "Chaque nuit sans mort de loup, peut tuer une 2e victime.",
    tags: ["Élimination"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Loups-Garous",
    color: "#7b241c",
    desc: "Sa victime devient loup au lieu de mourir — Le Maudit meurt à l'aube suivante.",
    tags: ["Transition"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#27ae60",
    desc: "Aucun pouvoir. Vote avec le village.",
    tags: ["Passif"],
    min: 0,
    max: 12,
    base: true,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#9b59b6",
    desc: "Chaque nuit, découvre le rôle d'un joueur.",
    tags: ["Voyance", "Nuit"],
    min: 0,
    max: 1,
    base: true,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#16a085",
    desc: "Possède une potion de vie et une potion de mort (une fois chacune).",
    tags: ["Protection", "Élimination"],
    min: 0,
    max: 1,
    base: true,
    origin: "Base",
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#d35400",
    desc: "À sa mort, tire immédiatement sur un joueur.",
    tags: ["Réaction"],
    min: 0,
    max: 1,
    base: true,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#e91e8c",
    desc: "La 1ère nuit, lie deux joueurs. Si l'un meurt, l'autre aussi.",
    tags: ["1ère nuit"],
    min: 0,
    max: 1,
    base: true,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#f39c12",
    desc: "Peut espionner les loups la nuit. Si surprise, meurt à leur place.",
    tags: ["Voyance", "Risqué"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#95a5a6",
    desc: "Survit à la 1ère attaque. Si le village l'élimine, tous les villageois perdent leurs pouvoirs.",
    tags: ["Protection"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#2980b9",
    desc: "Chaque nuit protège un joueur contre les loups.",
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#626567",
    desc: "Chaque nuit désigne un joueur : +2 votes contre lui le lendemain.",
    tags: ["Vote", "Nuit"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#a04000",
    desc: "En cas d'égalité au vote, il est sacrifié.",
    tags: ["Vote"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#f1c40f",
    desc: "S'il est voté, il survit mais perd son droit de vote.",
    tags: ["Protection"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Solitaires",
    color: "#8e44ad",
    desc: "Ensorcelle des joueurs chaque nuit. Gagne si tous les vivants sont ensorcelés.",
    tags: ["Solitaire", "Nuit"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#6e2f00",
    desc: "Si un voisin est loup, son moulin gronde à l'aube (50% de chance).",
    tags: ["Passif"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#e67e22",
    desc: "Désigne 1 joueur et apprend son camp. Perd son pouvoir s'il cible un villageois.",
    tags: ["Voyance", "Nuit"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#717d7e",
    desc: "S'il est dévoré, infecte son tueur loup : ce loup ne peut pas voter le jour suivant.",
    tags: ["Réaction"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#2c3e50",
    desc: "Chaque nuit interroge un mort : camp révélé.",
    tags: ["Voyance", "Nuit"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Solitaires",
    color: "#bdc3c7",
    desc: "Gagne s'il est éliminé par vote lors des 2 premiers tours.",
    tags: ["Solitaire"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Solitaires",
    color: "#d5dbdb",
    desc: "S'il est le premier à mourir, il hante un joueur/nuit.",
    tags: ["Solitaire"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Solitaires",
    color: "#6c3483",
    desc: "Gagne si tous les survivants sont du même camp que lui à la fin.",
    tags: ["Solitaire"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Ambigus",
    color: "#717d7e",
    desc: "La 1ère nuit, échange sa carte contre une carte supplémentaire.",
    tags: ["1ère nuit"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Ambigus",
    color: "#7b7d7d",
    desc: "Peut rejoindre les loups une seule fois.",
    tags: ["Choix"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Ambigus",
    color: "#1e8449",
    desc: "Choisit un mentor. Si ce mentor meurt d'un vote, l'Orphelin devient loup.",
    tags: ["Transition"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Spéciales",
    color: "#d4ac0d",
    desc: "Vote ×2. S'il est révélé loup, les loups perdent immédiatement.",
    tags: ["Vote"],
    min: 0,
    max: 1,
    base: false,
  ...
  },
  {
    ...
    camp: "Villageois",
    color: "#e74c3c",
    desc: "Marque un joueur/nuit. Au bout de 3 marques, il meurt.",
    tags: ["Accumulation", "Nuit"],
    min: 0,
    max: 1,
    base: false,
    origin: "Crépuscule",
...
let MY_NAME = "",
  MY_CODE = "",
  MY_PLAYER_ID = "p_" + Math.random().toString(36).slice(2, 10),
  IS_HOST = false,
  POLL_INTERVAL = null;
...
function renderGame() {
  ...
  badge.className = isNight || phase === "NIGHT_RESULT" ? "night" : "day";
  badge.textContent = phaseLabels[phase] || phase;
  $("round-num").textContent = game.round || 1;
  $("salon-code-display").textContent = `Code: ${MY_CODE || "—"}`;

  // Countdown
  updateCountdown(game.phaseEnd);
  ...
  if (me && myRole) {
    ...
    $("my-role-name").style.color = myRole.color;
    $("my-role-desc").textContent = myRole.desc;
    $("dead-badge")?.classList.toggle("hidden", !isDead);
  }

  // ── Zone centrale selon phase ──
...
function updateCountdown(phaseEnd) {
  ...
  const tick = () => {
    ...
    el.style.color =
      rem <= 10 ? "var(--red)" : rem <= 30 ? "var(--gold)" : "var(--muted)";
    if (rem <= 0) clearInterval(G.countdownInterval);
  };
  tick();
  G.countdownInterval = setInterval(tick, 1000);
}
